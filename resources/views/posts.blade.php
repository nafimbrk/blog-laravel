  ...
  <div class="col-md-6">
    <form action="/posts">
      ...
      <div class="input-group mb-3">
        ...
        <button class="btn btn-danger" type="submit">Saecrh</button>
      </div>
    </form>
  </div>
</div>
...
<div style="max-height: 400px; overflow:hidden;">
    <img src="{{ asset('storage/' . $posts[0]->image) }}" width="1200" height="400" alt="{{ $posts[0]->category->name }}" class="img-fluid mt-3">
</div>
@else
<img src="img/1.jpg" width="1200" height="400" class="card-img-top" alt="{{ $posts[0]->category->name }}">
@endif
      ...
      @foreach ($posts->skip(1) as $post)
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
              ...
              @else
              <img src="img/1.jpg" width="500" height="400" class="card-img-top" alt="{{ $post->category->name }}">
              @endif
